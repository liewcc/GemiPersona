...
# --- Page Configuration ---
# Version: 1.2.2
# Update: Implemented Session State key switching to fix 'Clear Gallery' button functionality.
st.set_page_config(page_title="Meta Data Reader v1.2.2", layout="wide")
...
with st.sidebar:
    ...
    st.markdown("### Version: 1.2.2")
    
    # Using the dynamic key from session_state
    ...
    if st.button("🗑️ Clear Gallery", use_container_width=True, on_click=clear_gallery):
...
if uploaded_files:
    ...
    for uploaded_file in uploaded_files:
        ...
        try:
            ...
            # --- Left Column: Image Display (Base64) ---
            with col1:
            ...
            with col2:
                ...
                # 1. Read PNG Textual Information
                png_info = img.info
                if png_info:
                    with st.expander("✨ Key Information (Text/Prompt)", expanded=True):
                        # Detect common keys for AI prompts
                ...
                if not png_info and not exif_data:
                    st.warning("No recognizable metadata found.")
    ...
    st.markdown("""
    ### 🚀 Getting Started
    1. Find the **Upload** section in the left sidebar.
    2. **Drag and drop** AI-generated images.
    3. The system will extract prompts and technical data automatically.
    """)

# Footer
st.sidebar.markdown("---")
st.sidebar.caption("Meta Data Reader - Version 1.2.2")